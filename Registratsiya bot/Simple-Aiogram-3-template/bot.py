...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum, Sifat o'quv markazining botiga hush kelibsiz,bu bot ruyhatdan o'tishizngizga yordam beradi,ruyhatdan utish uchun /ruyhatdanutish komandasini yuboring")
    except:
        await message.answer(text="Assalomu alaykum, Sifat o'quv markazining botiga hush kelibsiz,bu bot ruyhatdan o'tishizngizga yordam beradi,ruyhatdan utish uchun /ruyhatdanutish komandasini yuboring")
...
@dp.message(Command("ruyhatdanutish"))
async def command_start_handler(message: Message,state:FSMContext) -> None:
    await state.set_state(Form.first_name)
    full_name = message.from_user.full_name
    text = f"{full_name} Ro'yhatdan o'tish uchun ismingizni kiriting!"
    await message.reply(text=text)

@dp.message(F.text)
async def hohlagan_soz(message:Message):
